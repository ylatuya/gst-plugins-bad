...
{
  if (!gst_element_register (plugin, "keyunits-scheduler", GST_RANK_NONE,
          GST_TYPE_KEY_UNITS_SCHEDULER) || FALSE)
    return FALSE;
  return TRUE;
}
...
GST_PLUGIN_DEFINE (GST_VERSION_MAJOR,
    GST_VERSION_MINOR,
    "keunits-scheduler",
    "Scheduler for ForceKeyUnit events",
    plugin_init, VERSION, "LGPL", PACKAGE_NAME, "http://www.gstreamer.org/")
