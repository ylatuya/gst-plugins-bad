...
GstAmcSurfaceTexture * gst_amc_surface_texture_new   (void);

void gst_amc_surface_texture_set_default_buffer_size (GstAmcSurfaceTexture *texture,
                                                      gint width, gint height);

void gst_amc_surface_texture_update_tex_image        (GstAmcSurfaceTexture *texture);

void gst_amc_surface_texture_detach_from_gl_context  (GstAmcSurfaceTexture *texture);

void gst_amc_surface_texture_attach_to_gl_context    (GstAmcSurfaceTexture *texture,
                                                      gint index);

void gst_amc_surface_texture_get_transform_matrix    (GstAmcSurfaceTexture *texture,
                                                      const gfloat *matrix);

gint64 gst_amc_surface_texture_get_timestamp         (GstAmcSurfaceTexture *texture);

void gst_amc_surface_texture_release                 (GstAmcSurfaceTexture *texture);
